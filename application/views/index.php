...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href='<?php echo base_url() ?>index_style/fonts/icomoon/style.css"?>';>

    <link rel="stylesheet" href="<?php echo base_url(); ?>index_style/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>index_style/css/jquery-ui.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>index_style/css/owl.carousel.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>index_style/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>index_style/css/owl.theme.default.min.css">

    <link rel="stylesheet" href="<?php echo base_url(); ?>index_style/css/jquery.fancybox.min.css">

    <link rel="stylesheet" href="<?php echo base_url(); ?>index_style/css/bootstrap-datepicker.css">

    <link rel="stylesheet" href="<?php echo base_url(); ?>index_style/fonts/flaticon/font/flaticon.css">

    <link rel="stylesheet" href="<?php echo base_url(); ?>index_style/css/aos.css">

    <link rel="stylesheet" href="<?php echo base_url(); ?>index_style/css/style.css">
  ...
  <div class="site-wrap">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-6">
            <p class="mb-0 float-right">
              <span class="mr-3"><a href="tel://#"> <span class="icon-phone mr-2" style="position: relative; top: 2px;"></span><span class="d-none d-lg-inline-block text-black">(+91) 1234567890</span></a></span>
              <span><a href="#"><span class="icon-envelope mr-2" style="position: relative; top: 2px;"></span><span class="d-none d-lg-inline-block text-black">www.kidsart.com</span></a></span>
            </p>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.html" class="text-black mb-0">KidsArt<span class="text-primary">.</span> </a></h1>
          </div>
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href='<?php echo base_url()."index.php/AdminControl/register" ?>' class="nav-link">Registration</a></li>
                <li><a href='<?php echo base_url()."index.php/AdminControl/login" ?>' class="nav-link">Login</a></li>
              </ul>
            </nav>
          </div>
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(<?php echo base_url(); ?>index_style/images/sleeping_baby.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
          ...
          <div class="col-md-12" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row mb-4">
              <div class="col-md-7">
                ...
                <div>
                  <a href='<?php echo base_url()."index.php/AdminControl/login" ?>' class="btn btn-white btn-outline-white py-3 px-5 rounded-0 mb-lg-0 mb-2 d-block d-sm-inline-block">Shop Now</a>
                  <a href='<?php echo base_url()."index.php/AdminControl/register" ?>' class="btn btn-white py-3 px-5 rounded-0 d-block d-sm-inline-block">Club Membership</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-6 text-center">
            <h3 class="section-sub-title">Popular Product</h3>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="<?php echo base_url(); ?>index_style/images/infant2.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Infant</a></h3>
                <div class="mb-3">
                </div>
                <div>
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="<?php echo base_url(); ?>index_style/images/boy2.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Boys</a></h3>
                <div class="mb-3">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="<?php echo base_url(); ?>index_style/images/girl.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
          ...
          <!-- <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="<?php echo base_url(); ?>index_style/images/model_4_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="<?php echo base_url(); ?>index_style/images/model_5_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Wild West Hoodie</a></h3>
                <div class="mb-3">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="<?php echo base_url(); ?>index_style/images/product_1_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Wild West Hoodie</a></h3>
                <div class="mb-3">
    ...
    <div class="site-blocks-cover inner-page-cover overlay get-notification"  style="background-image: url(<?php echo base_url(); ?>index_style/images/sleeping_baby.jpg); background-attachment: fixed;" data-aos="fade">
      <div class="container">
        ...
        <div class="bg-white py-4 mb-4">
          <div class="row mx-4 my-4 product-item-2 align-items-start">
            <div class="col-md-6 mb-5 mb-md-0">
              <img src="<?php echo base_url(); ?>index_style/images/model_1_bg.jpg" alt="Image" class="img-fluid">
            </div>
      ...
      <div class="container">
        <div class="row align-items-lg-center">
          <div class="col-md-8 mb-5 mb-lg-0 position-relative">
            <img src="<?php echo base_url(); ?>index_style/images/boy2.jpg" class="img-fluid" alt="Image">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
            <div class="person text-center">
              <img src="<?php echo base_url(); ?>index_style/images/person_2.jpg" alt="Image" class="img-fluid rounded w-75 mb-3">
              <h3>John Rooster</h3>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
            <div class="person text-center">
              <img src="<?php echo base_url(); ?>index_style/images/person_3.jpg" alt="Image" class="img-fluid rounded w-75 mb-3">
              <h3>Tom Sharp</h3>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="300">
            <div class="person text-center">
              <img src="<?php echo base_url(); ?>index_style/images/person_4.jpg" alt="Image" class="img-fluid rounded w-75 mb-3">
    ...
    <div class="site-blocks-cover overlay get-notification" id="special-section" style="background-image: url(<?php echo base_url(); ?>index_style/images/hero_2.jpg); background-attachment: fixed; background-position: top;" data-aos="fade">
      <div class="container">
      ...
      <div class="slide-one-item home-slider owl-carousel">
          <div>
            <div class="testimonial">
              <figure class="mb-4 d-block align-items-center justify-content-center">
                <div><img src="<?php echo base_url(); ?>index_style/images/person_3.jpg" alt="Image" class="w-100 img-fluid mb-3"></div>
              </figure>
          ...
          <div>
            <div class="testimonial">
              ...
              <figure class="mb-4 d-block align-items-center justify-content-center">
                <div><img src="<?php echo base_url(); ?>index_style/images/person_2.jpg" alt="Image" class="w-100 img-fluid mb-3"></div>
              </figure>
          ...
          <div>
            <div class="testimonial">
              <figure class="mb-4 d-block align-items-center justify-content-center">
                <div><img src="<?php echo base_url(); ?>index_style/images/person_4.jpg" alt="Image" class="w-100 img-fluid mb-3"></div>
              </figure>
              <blockquote class="mb-3">
                <p>&ldquo;Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur unde reprehenderit aperiam quaerat fugiat repudiandae explicabo animi minima fuga beatae illum eligendi incidunt consequatur. Amet dolores excepturi earum unde iusto.&rdquo;</p>
              </blockquote>
          ...
          <div>
            <div class="testimonial">
              <figure class="mb-4 d-block align-items-center justify-content-center">
                <div><img src="<?php echo base_url(); ?>index_style/images/person_1.jpg" alt="Image" class="w-100 img-fluid mb-3"></div>
              </figure>
              <blockquote class="mb-3">
                <p>&ldquo;Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur unde reprehenderit aperiam quaerat fugiat repudiandae explicabo animi minima fuga beatae illum eligendi incidunt consequatur. Amet dolores excepturi earum unde iusto.&rdquo;</p>
              </blockquote>
          ...
          <div class="col-md-8">
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <a href="#" class="pl-0 pr-5"><span class="icon-facebook">facebook</span></a><br>
                <a href="#" class="pl-0 pr-3"><span class="icon-twitter">twitter</span></a><br>
                <a href="#" class="pl-0 pr-3"><span class="icon-instagram">instagram</span></a><br>
                <a href="#" class="pl-0 pr-3"><span class="icon-linkedin">linkedin</span></a>
              </div>
            </div>
          </div>
          <!-- <div class="col-md-3 ml-auto">
  ...
  <script src="<?php echo base_url(); ?>index_style/js/jquery-3.3.1.min.js"></script>
  <script src="<?php echo base_url(); ?>index_style/js/jquery-migrate-3.0.1.min.js"></script>
  <script src="<?php echo base_url(); ?>index_style/js/jquery-ui.js"></script>
  <script src="<?php echo base_url(); ?>index_style/js/popper.min.js"></script>
  <script src="<?php echo base_url(); ?>index_style/js/bootstrap.min.js"></script>
  <script src="<?php echo base_url(); ?>index_style/js/owl.carousel.min.js"></script>
  <script src="<?php echo base_url(); ?>index_style/js/jquery.stellar.min.js"></script>
  <script src="<?php echo base_url(); ?>index_style/js/jquery.countdown.min.js"></script>
  <script src="<?php echo base_url(); ?>index_style/js/bootstrap-datepicker.min.js"></script>
  <script src="<?php echo base_url(); ?>index_style/js/jquery.easing.1.3.js"></script>
  <script src="<?php echo base_url(); ?>index_style/js/aos.js"></script>
  <script src="<?php echo base_url(); ?>index_style/js/jquery.fancybox.min.js"></script>
  <script src="<?php echo base_url(); ?>index_style/js/jquery.sticky.js"></script>

  
  <script src="<?php echo base_url(); ?>index_style/js/main.js"></script>
