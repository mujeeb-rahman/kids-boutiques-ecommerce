  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class=" border-right" id="sidebar-wrapper">
      ...
      <ul class="list-group list-group-flush">
		<li class="list-group-item"><span class="text-secondary font-family-roboto small">Boutique Tools</span></li>
        <li class="list-group-item"><a href='<?php echo base_url()."index.php/BoutiqueControl/home" ?>'  class="list-group-item-action">Home</a></li>
        <li class="list-group-item"><a href='<?php echo base_url()."index.php/BoutiqueControl/products" ?>'  class="list-group-item-action">Products</li></a>
        <li class="list-group-item"><a href='<?php echo base_url()."index.php/BoutiqueControl/customers" ?>'  class="list-group-item-action">Customers</li></a>
        <li class="list-group-item"><a href='<?php echo base_url()."index.php/BoutiqueControl/orders" ?>'  class="list-group-item-action">Orders</li></a>
    ...
    <div id="page-content-wrapper">
      ...
      <nav class="navbar navbar-expand-lg navbar-light  border-bottom">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" id="menu-toggle" aria-controls="menu-toggle" aria-expanded="false" aria-label="Toggle navigation">
         ...
         <div>
          <h5 class="text-right"> BOUTIQUE MANAGER</h5>
         </div>
          ...
          <ul class="navbar-nav ml-auto mt-lg-0">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				...
				<p class="px-5mr-2 d-lg-inline text-secondary font-family-roboto small">Boutique Manager</p>
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href='<?php echo base_url()."index.php/BoutiqueControl/boutiqueProfile" ?>'>
